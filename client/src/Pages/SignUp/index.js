...
const SignUp = () => {
    ...
    return(
        <section className="section signInPage signUpPage">
            ...
            <path class="st0" d="M1921,413.1v406.7H0V0.5h0.4l228.1,598.3c30,74.4,80.8,130.6,152.5,168.6c107.6,57,
            212.1,40.7,245.7,34.4 c22.4-4.2,54.9-13.1,97.5-26.6L1921,400.5V413.1z"></path></svg>
            </div>
            ...
            <div className="container">
                <div className="box card p-3 shadow border-0">
                  ...
                  <div className="row">
                     ...
                     <div className="form-group">
                        <TextField id="standard-basic" label="Paaword" type="password" required variant="standard" className="w-100" />
                     </div>


                     <a className="border-effect cursor txt">Forgot Paaword?</a>
                     ...
                     <div className="d-flex align-items-center  mt-3 mb-3">
                       ...
                       <div className="col-md-6">
                          <Link to="/" className="d-block w-100"><Button className="btn-lg btn-big w-100" variant="outlined" onClick={()=>context.setHeaderFooterShow(true)}>Cancel</Button>
                          </Link>
                       </div>
                     </div>   
