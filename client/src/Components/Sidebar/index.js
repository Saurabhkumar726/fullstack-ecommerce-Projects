...
const Sidebar = () =>{
    ...
    return(
        ...
        <div className="sidebar">
            ...
            <div className="filterBox">
                ...
                <div className='scroll'>
                    <ul>
                        ...
                        <li><FormControlLabel className='w-100' control={<Checkbox/>} label="Campus" /></li>
                        <li><FormControlLabel className='w-100' control={<Checkbox/>} label="Nike" /></li>
                        <li><FormControlLabel className='w-100' control={<Checkbox/>} label="Campus" /></li>
                        <li><FormControlLabel className='w-100' control={<Checkbox/>} label="Nike" /></li>
                        <li><FormControlLabel className='w-100' control={<Checkbox/>} label="Campus" /></li>
            ...
            <Link to="#"><img src='https://klbtheme.com/bacola/wp-content/uploads/2021/05/sidebar-banner.gif'
            className='w-100'/>
            </Link>
        </div>
